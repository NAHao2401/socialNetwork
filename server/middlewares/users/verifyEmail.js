...
const { verifyEmailHTML } = require("../../utils/emailTemplates.js");

const CLIENT_URL = process.env.CLIENT_URL;
const EMAIL_SERVICE = process.env.EMAIL_SERVICE;

const verifyEmailValidation = [
  query("email").isEmail().normalizeEmail(), //Kiểm tra email đúng định dạng email không, nếu hợp lệ thì format lại
  query("code").isLength({ min: 5, max: 5 }), //Code bắt buộc dài chính xác 5 kí tự
  (req, res, next) => {
