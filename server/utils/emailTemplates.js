...
<div
  style="
    ...
    padding: 20px;
    border-radius: 10px;
    box-shadow: 0 2px 4px rgb(104, 182, 255);
  "
>
  <div style="background-color: #ffffff; padding: 20px; border-radius: 10px">
    <img
      ...
      alt="SocialEcho Logo"
      style="display: block; margin: auto auto 20px; max-width: 50%"
    />
    <p
      style="
        font-size: 18px;
    ...
    <p
      ...
      "
    >
      Please note that the device you are using for this verification process
      will be set as your primary device.
    </p>
    <p
      style="
        font-size: 14px;
    ...
    >
      ...
      <span style="color: #000000">${verificationCode}</span>
    </p>
    <p
      style="
        font-size: 14px;
...
`; const verifyLoginHTML = ( name, verificationLink, blockLink,
currentContextData ) => `
<div style="background-color: #f4f4f4; padding: 20px">
  <div style="background-color: #fff; padding: 20px; border-radius: 10px">
    ...
    <p>Dear ${name},</p>
    <p>
      Our system has detected that a new login was attempted from the following
      device and location at ${currentContextData.time}:
    </p>
    <ul style="list-style: none; padding-left: 0">
      <li><strong>IP Address:</strong> ${currentContextData.ip}</li>
      <li>
        <strong>Location:</strong> ${currentContextData.city},
        ${currentContextData.country}
      </li>
      <li>
        <strong>Device:</strong> ${currentContextData.device}
    ...
    <p>
      If you believe this was an unauthorized attempt, please click the button
      below to block this login:
    </p>
    <div style="text-align: center">
      <a
        href="${blockLink}"
    ...
    <p>
      Please verify that this login was authorized. If you have any questions or
